const en = {
    ...
    UPDATEMATCH: 'Update a booking detail information',
    INSERTBOOKING: 'Insert a new booking',
    DECLINEBOOKING: 'Decline a booking',
    APPROVALBOOKING: 'Approval a booking',
    CHANGEPERMISSION: 'Grant permissions',
    INSERTPITCH: 'Insert a new stadium',
    UPDATEPITCH: 'Update a stadium',
    INSERTACCOUNT: 'Insert a new account',
    UPDATEACCOUNT: 'Update account',
    INSERTSERVICIE: 'Insert a new item/service',
    UPDATESERVICE: 'Update a item/service',
    INSERTINVOICE: 'Insert a new invoice',
