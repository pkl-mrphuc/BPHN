const vi = {
    ...
    VIEWSTATISTIC: 'Xem dữ liệu thống kê',
    ...
    UPDATEMATCH: 'Cập nhật chi tiết booking',
    INSERTBOOKING: 'Thêm mới booking',
    DECLINEBOOKING: 'Từ chối đặt sân',
    APPROVALBOOKING: 'Phê duyệt đặt sân',
    CHANGEPERMISSION: 'Cấp quyền cho tài khoản',
    INSERTPITCH: 'Thêm mới sân bóng}',
    UPDATEPITCH: 'Cập nhật sân bóng',
    INSERTACCOUNT: 'Thêm mới tài khoản',
    UPDATEACCOUNT: 'Cập nhật tài khoản',
    INSERTSERVICIE: 'Thêm mới hàng hóa',
    UPDATESERVICE: 'Cập nhật hàng hóa',
