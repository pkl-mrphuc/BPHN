...
const save = () => {
  ...
  if (!fullName.value) {
    ElNotification({ title: t("Notification"), message: t("FullNameEmptyMesg"), type: "warning", });
    return;
  }
  ...
  if (!isEmail(email.value)) {
    ElNotification({ title: t("Notification"), message: t("InvalidEmail"), type: "warning", });
    return;
  }
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-12 col-sm-12 col-md-8">
            ...
            <div class="row">
              <div class="mb-2 col-12 col-sm-12 col-md-4 fw-bold">{{ t("Email") }}
            ...
            <div class="row">
              <div class="mb-2 col-12 col-sm-12 col-md-4 fw-bold">{{ t("FullName") }}
                <span class="text-danger">(*)</span>
              </div>
              <div class="mb-2 col-12 col-sm-12 col-md-8">
            ...
            <div class="row">
              <div class="mb-2 col-12 col-sm-12 col-md-4 fw-bold">{{ t("Gender") }}</div>
              <div class="mb-2 col-12 col-sm-12 col-md-8">
            ...
            <div class="row">
              <div class="mb-2 col-12 col-sm-12 col-md-4 fw-bold">{{ t("PhoneNumber") }}
                <span class="text-danger">(*)</span>
              </div>
              <div class="mb-2 col-12 col-sm-12 col-md-8">
