...
const functionName = (functionType) => {
  switch (functionType) {
    case FunctionTypeEnum.ADDPITCH: return t("ADDPITCH");
    case FunctionTypeEnum.EDITPITCH: return t("EDITPITCH");
    case FunctionTypeEnum.VIEWLISTPITCH: return t("VIEWLISTPITCH");
    case FunctionTypeEnum.ADDBOOKING: return t("ADDBOOKING");
    case FunctionTypeEnum.EDITBOOKING: return t("EDITBOOKING");
    case FunctionTypeEnum.VIEWLISTBOOKING: return t("VIEWLISTBOOKING");
    case FunctionTypeEnum.ADDUSER: return t("ADDUSER");
    case FunctionTypeEnum.EDITUSER: return t("EDITUSER");
    case FunctionTypeEnum.VIEWLISTUSER: return t("VIEWLISTUSER");
    case FunctionTypeEnum.VIEWLISTBOOKINGDETAIL: return t("VIEWLISTBOOKINGDETAIL");
    case FunctionTypeEnum.ADDINVOICE: return t("ADDINVOICE");
    case FunctionTypeEnum.EDITINVOICE: return t("EDITINVOICE");
    case FunctionTypeEnum.VIEWLISTINVOICE: return t("VIEWLISTINVOICE");
    ...
    <template #body>
      <el-table :data="lstPermission">
        <el-table-column :label="t('FunctionName')">
          <template #default="scope">{{ functionName(scope.row.functionType) }}</template>
        </el-table-column>
