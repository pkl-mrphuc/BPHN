      ...
      <el-form>
        ...
        <div class="row">
          <div class="mb-2 col-12 col-sm-4">
            <div class="mx-2">
              <el-select class="w-100" :placeholder="t('Infrastructure')" v-model="pitchId" @change="changePitchId">
        ...
        <div class="mb-2" v-if="!isRecurring">
          <div class="mx-2">
            <el-date-picker type="date" placeholder="Ngày" class="w-100" v-model="fromDate" @change="changeDate" :disabled-date="disabledDate"/>
          </div>
        </div>
    ...
    <template #foot>
      <div class="row d-flex flex-row-reverse justify-content-between align-items-center">
        ...
        <div class="d-flex flex-row-reverse">
          ...
          <el-button class="mb-2 mr-2" @click="quickCheck">{{ t("QuickCheck") }}</el-button>
        </div>
      </div>
    </template>
  </Dialog>
